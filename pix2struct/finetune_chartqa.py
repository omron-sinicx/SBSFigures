...
def main():
    ...
    parser.add_argument('--checkpoint-processor', type=str, default= "naver-clova-ix/donut-base", help='Checkpoint path for processor')
    parser.add_argument('--checkpoint-model', type=str, default= "naver-clova-ix/donut-base", help='Checkpoint path for model')

    args = parser.parse_args()

    # Load the processor and model
    processor = Pix2StructProcessor.from_pretrained(args.checkpoint_processor)
    ...
    wandb_logger = WandbLogger(project="Finetune-ChartQA")
