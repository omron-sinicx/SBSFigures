...
class ChartQADataset(Dataset):
    ...
    def __getitem__(self, idx: int):
        ...
        processed_img = self.processor(img.convert("RGB"), random_padding=self.split == "train", return_tensors="pt")

        pixel_values = processed_img["flattened_patches"]
...
class ChartQADatasetTest(Dataset):
    """
    """
    ...
    def __getitem__(self, idx: int):
        ...
        if self.split == "train":
            ...
            return input_tensor, input_ids, prompt_end_index, processed_parse,test_type